                            ...
                            <li key={e.id} className="w-416px product hover:active-hover">
                                ...
                                >
                                    {/* swiper images  */}
                                    {
                                        e.images.map((img) => {
                                            return (
                                                <SwiperSlide key={img.id} style={{ backgroundImage: `url(${img.img})` }} className="flex flex-col items-end p-5 relative bg-cover bg-center bg-no-repeat">
                                                    <div className="flex-center tabs-wrapper opacity-100 space-x-3 ml-auto transition-opacity-2">
                                                        {
                                                            e.aksiya &&
...
export default LeadingProducts;