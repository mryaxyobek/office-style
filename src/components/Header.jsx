    ...
    return (
        <header className={`py-4 bg-primary-gray-04 relative`}>
            <div className="flex-c-b container">
                ...
                {/* logo  */}
                <Link to='/' className='text-primary-gray-90 text-2xl leading-25px textblack max-800:text-xl max-800:leading-5 max-540:text-lg max-540:leading-17.5px max-440:text-base max-440:leading-4'>ОФИС-СТИЛЬ.</Link>
