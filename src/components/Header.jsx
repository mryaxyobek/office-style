            ...
            <div className="flex-c-b container">
                ...
                <nav>
                    <ul className="flex-center space-x-6 text-regular-14">
                        ...
                        <li>
                            <Link className="text-primary-gray-70" to='/'>Доставка и оплата</Link>
                        </li>
                        <li>
                ...
                {/* bottom content  */}
                <div className="z-3 absolute w-full -bottom-62px left-0 pt-18px">
                    <div className="flex-c-b container">
                        <div className="flex-center">
                            ...
                            <nav className={`${openSearchInput ? 'hidden' : ''}`}>
                                <ul className={`${changeText ? 'text-white' : ''} flex-center space-x-10 text-regular-16`}>
                                    <li>
                                        <Link className="" to='/'>Кабинеты для руководителей</Link>
                                    </li>
                                    <li>
                                        <Link className="" to='/'>Мебель для персонала</Link>
                                    </li>
                                    <li>
                                        <Link className="" to='/'>Офисные кресла</Link>
                                    </li>
                                    <li>
                                        <Link className="" to='/'>Стойки рецепшн</Link>
                                    </li>
                                    <li>
                                        <Link className="" to='/'>Столы для переговоров</Link>
                                    </li>
                                </ul>
                            </nav>
                        </div>
