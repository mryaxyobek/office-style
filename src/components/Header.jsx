    ...
    return (
        <header className={`py-4 bg-primary-gray-04 relative`}>
            <div className="flex-c-b container">
                ...
                {/* logo  */}
                <Link to='/' className='text-primary-gray-90 text-2xl leading-25px textblack max-800::text-xl'>ОФИС-СТИЛЬ.</Link>
                ...
                <div className='flex-center'>
                    <p className="leading-5 text-primary-gray-70 mr-16 max-1500:mr-5 text-regular-14 max-1300:hidden">ул. Красных Партизан д. 198</p>
                    ...
                    <button className="flex items-center justify-center bg-primary-gray-80 rounded-lg max-1200:!text-xs py-3.5 px-6 text-white text-regular-14 max-1050:bg-transparent max-1050:w-9 max-1050:h-9 max-1050:border max-1050:p-0 max-1050:border-primary-gray-20 max-900:mr-4">
                        <span className="max-1050:hidden">Заказазать звонок</span>
                    ...
                    <div className="hidden space-x-4 max-900:flex">
