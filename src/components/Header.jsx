                        ...
                        <div className="flex-center space-x-3.5">
                            ...
                            <div className="relative">
                                <form onSubmit={preventdefault} className="flex-center justify-center relative">
                                    ...
                                    {/* search btn */}
                                    <button type='button' onClick={openSearchInputFunc} className={`${openSearchInput ? 'border-l-0 search-btn bg-white' : ''} ${changeText ? openSearchInput ? 'border-secondary-gray-50':'border-white' : openSearchInput ? 'border-secondary-gray-50':'border-black'} transition-all duration-300 relative z-1 p-11px rounded-lg border `}>
                            ...
                            {/* link  */}
                            <Link to='/' className={`transition-all duration-300 ${openSearchInput ? '!rounded-100%' : 'rounded-lg'} ${changeText ? 'border-white' : 'border-black'} border relative inline-block p-11px`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
