        ...
        <header className={`py-4 bg-primary-gray-04 relative`}>
            <div className="flex-c-b container">
                ...
                <div className='flex-center'>
                    ...
                    <button onClick={openCallModalFunction} className="flex items-center justify-center bg-primary-gray-80 rounded-lg max-1200:!text-xs py-3.5 px-6 text-white text-regular-14 max-1050:bg-transparent max-1050:w-9 max-1050:h-9 max-1050:border max-1050:p-0 max-1050:border-primary-gray-20 max-900:mr-4 max-730:mr-3 max-670:mr-2">
                ...
                <div style={{ backgroundColor: openCatalog ? 'white' : 'transparent' }} className="z-3 absolute w-full -bottom-20 left-0 py-18px transition-colors-2 max-900:hidden">
                    <div className="flex-c-b container">
                        ...
                        <div className="flex-center space-x-3.5">
                            ...
                            {/* basket link  */}
                            <Link to='/basket' className={`inline-block  transition-all duration-300  ${openSearchInput ? '!rounded-100%' : 'rounded-lg'} ${openCatalog ? 'scale-0 !m-0' : 'scale-100'} ${changeText ? 'border-white' : 'border-black'} border relative p-11px`}>
                                <svg xmlns="http://www.w3.org/2000/svg" width="17" height="17" viewBox="0 0 17 17" fill="none">
