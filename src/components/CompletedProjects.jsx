                ...
                <ul className="grid grid-cols-1 gap-60px completed-products-list max-1200:gap-14 max-1050:gap-12 max-900:gap-10 max-440:gap-8">
                    {
                        completedProjectsData.map((e) => {
                            return (
                                <li key={e.id} className='grid grid-cols-2 gap-8 p-6 bg-primary-gray-04 rounded-2.5xl max-640:p-0'>

                                    {/* first child  */}
                                    <div className='flex flex-col items-start max-640:p-6 max-640:!pt-0 max-540:p-5 max-440:p-4'>
                                        {/* title  */}
                                        <h3 className="text-regular-36 mb-9 max-900:text-regular-32 max-900:mb-8 max-640:mb-7 max-640:text-regular-28 max-440:text-regular-24 max-440:mb-6 max-360:text-regular-20">{e.title}</h3>
                                                        ...
                                                        return (
                                                            <tr key={detail.id} className="inline-block w-full first:border-t py-2 border-b border-primary-gray-20">
                                                                <td className="flex-c-b gap-5">
                                                                    ...
                                                                    {/* price  */}
                                                                    <span className='text-gray-700 text-regular-16 min-w-max'>{detail.price}₽</span>
                                                                </td>
                                                            </tr>
                                                        )
                                                    })
