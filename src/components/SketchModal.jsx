...
const SketchModal = () => {
    ...
    // close modal
    const closeSketchModalFunction = () => {
        dispatch(closeSketchModal());
    };
        ...
        <>
            ...
            <div className="flex-center' flex-center fixed justify-center top-0 right-0 w-full h-screen z-50">
                ...
                <div className="flex relative w-full max-w-1088px h-full max-h-640px max-730:justify-center max-580:max-h-full">
                    {/* close modal button */}
                    <button onClick={closeSketchModalFunction} className="absolute red-btn top-5 right-5 z-5">
                    ...
                    <form
                        ...
                        <div className="my-auto">
                            ...
                            <div className="space-y-6 mb-8">
                                <div>
                                    <label htmlFor='sketchModalNameInput' className="inline-block mb-2 text-regular-14 text-primary-gray-70">Ismingiz</label>
                                    <input autoComplete='off' id='sketchModalNameInput' maxLength={13} name='user name' placeholder='Ismingiz' required type="text" className='leading-17.5px!' />
                                </div>

                                <div>
                                    <label htmlFor='sketchModalPhoneNumInput' className="inline-block mb-2 text-regular-14 text-primary-gray-70">Telefon raqamingiz</label>
                                    <input autoComplete='off' id='sketchModalPhoneNumInput' maxLength={13} name='phone number' placeholder='+998 (99) 999-99-99' required type="tel" className='leading-17.5px!' />
                                </div>
