                    ...
                    return (
                        <li key={product.id} className="w-full product hover:active-hover">
                            ...
                            <div className="flex flex-co w-full gap-2">
                                <Link to={`/catalog/${categoryName}/${product.productTitleNoSpacing}`} className="flex-center justify-center red-btn py-2.5 px-5 w-full bg-primary-red-60">Buyurtma berish</Link>
