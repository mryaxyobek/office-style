...
const RecommendProducts = () => {
    ...
    useEffect(() => {
        if (pathArr[1] === 'boshqaruvchilar-uchun') {
            setProducts(furnitureForStaff);
        } else if (pathArr[1] === 'xodimlar-uchun') {
            setProducts(cabinetProductsForManagers);
        } else if (pathArr[1] === 'boshqaruvchi-stuli') {
            setProducts(officeChair);
        } else if (pathArr[1] === 'ofis-stuli') {
            setProducts(managersChair);
        } else if (pathArr[1] === 'ofis-divani') {
            setProducts(receptionDesks);
        } else if (pathArr[1] === 'qabul-qilish-stoli') {
            setProducts(officeSofas);
        } else if (pathArr[1] === 'call-markazlari-uchun-mebel') {
            setProducts(courtFurnitures);
        } else if (pathArr[1] === 'sud-mebellari') {
            setProducts(furnitureForCallCenter);
        };
    }, [location.pathname]);
