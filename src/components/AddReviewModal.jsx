...
const CallModal = () => {
    ...
    return (
        <>
            {/* modal parent  */}
            <div className="flex-center' flex-center fixed justify-center top-0 right-0 w-full h-screen z-40">
                {/* overlay */}
                ...
                <div className="flex relative w-full max-w-1088px h-full max-h-640px max-730:justify-center max-580:max-h-full">
                    ...
                    {/* image */}
                    <img src={addReview} width={600} height={640} alt='add review image' className="absolute z-1 right-0 rounded-r-2.5xl top-0 h-full w-52% object-cover object-right-top max-730:hidden bg-primary-gray-30" />
                </div >
            </div >
        </>
    )
